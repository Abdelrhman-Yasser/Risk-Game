#include "gameset_visualizer.h"


/* utilities */
/******************************************/
string
gameset_visualizer::enum_agent_type_to_string(agent_type p_type)
{
...
string
gameset_visualizer::enum_gameplay_id_to_string(gameplay_id player_id)
{
...
string
gameset_visualizer::enum_action_to_string(action a_type)
{
...
/******************************************/
void
gameset_visualizer::display_country_info(struct country *c)
{
	cout << "(id : " << c->id << ")\t";
...
void
gameset_visualizer::display_banner(string title)
{
	cout << "**************************************************************************************" << endl;
	cout << "**************************************************************************************" << endl;
	cout << "\t\t\t\t    " << title << endl;
...
/******************************************/
void
gameset_visualizer::display_continents(environment *game_set)
{
...
void
gameset_visualizer::display_player_perspective(gameplay_id player_id, environment *game_set)
{
...
/******************************************/
void
gameset_visualizer::announce_player_turn(gameplay_id player_turn, agent_type p_type, int reserve_troops_count)
{
	//string a_type;
	//if()
	cout << endl;
...
/******************************************/
void
gameset_visualizer::display_game_board(environment *game_set, gameplay_id player_turn, agent_type p_type, int reserve_troops_count, action a_type)
{
	// clear display
	system("clear");
...
/******************************************/
void
gameset_visualizer::display_winner_banner(gameplay_id winner_id)
{
	// clear display
	system("clear");
